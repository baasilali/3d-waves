...
let app = {
  ...
  fragmentShader() {
    ...
    void main() {
      ...
      // Mix between white (1.0) and gray (0.5) based on y-coordinate
      float grayValue = mix(0.5, 1.0, st.y);
  ...
  async initScene() {
    ...
    // Change GUI accent color to white
    ...
    style.textContent = `
      ...
      .dg.main .cr.number .slider {
        background: rgba(255, 255, 255, 0.2) !important;
      }
      .dg.main .cr.number .slider-fg {
        background: white !important;
      }
      .dg.main .cr.number .slider-line {
        background: white !important;
      }
      .dg.main .cr.number .slider-fg::before {
        background: white !important;
      }
      .dg.main .cr.number .slider-fg::after {
        background: white !important;
      }
      .dg.main .cr.number .slider-fg:hover::before,
      .dg.main .cr.number .slider-fg:hover::after {
        background: white !important;
      }
      .dg.main .cr.number .slider-fg:active::before,
      .dg.main .cr.number .slider-fg:active::after {
        background: white !important;
      }
      /* Remove blue bar on the left */
      .dg .cr.function:hover, .dg .cr:hover {
      ...
      /* Remove all blue borders and highlights */
      .dg li:not(.folder) {
